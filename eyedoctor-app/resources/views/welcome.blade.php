...
>
                    ...
                    <div>
                        ...
                        <span
                            class="text-[10px]
                                   ...
                                   text-right"
                        >
                            Click and drag on the image to pan when zoomed.
                        </span>
        ...
        >
            ...
            <div>
                ...
                >
                    ...
                    <span
                        ...
                        class="hidden text-xs
                               ...
                               font-mono"
                    >
                        Analyzing<span id="loader-dots">...</span>
                    </span>
                ...
                >
                    ...
                    <select
                        id="doctor-override"
                        onchange="overrideDiagnosis(this.value)"
                        class="w-full
                               bg-slate-900
                    ...
                    <textarea
                        id="correction-note"
                        placeholder="Optional note (e.g. reasoning for this correction)"
                        class="w-full
                               bg-slate-900
                               border border-slate-600
                               text-xs font-mono
                ...
                <div class="mb-4">
                    ...
                    <button
                        onclick="document.getElementById('icdr-panel').classList.toggle('hidden')"
                    ...
                    >
                        ...
                        <p>
                            ...
                            No visible abnormalities on fundus exam.
                        </p>
                        ...
                        <p>
                            ...
                            Extensive hemorrhages, definite venous beading,
                        ...
                        >
                            Adapted from the International Clinical
            ...
            >
                ...
                <p
                    class="text-[9px]
                           ...
                           mt-2"
                >
                    For clinical decision support only. Predictions must be
                    reviewed by a qualified eye care professional and are not
    ...
    <script>
        ...
        function drawCanvas() {
            ...
            const brightness =
                document.getElementById('bright-slider').value;
            ...
            document.getElementById('contrast-val').innerText =
                `${contrast}%`;
        ...
        function startLoader() {
            ...
            const dots =
                document.getElementById('loader-dots');
        ...
        function runInference(event) {
            ...
            .then(data => {
                ...
                const stageIndex =
                    labelToStageIndex[data.predicted_label];
                ...
                const reviewFlag =
                    document.getElementById('review-flag');
                ...
                const atypicalFlag =
                    document.getElementById('atypical-flag');
                ...
                document
                    ...
                    data.inference_time_ms
                        ? `${Math.round(data.inference_time_ms)} ms`
                        : "\u2014";
        ...
        function renderReferralDecision(data) {
            ...
            const headline =
                document.getElementById('referral-headline');


            const subtext =
                document.getElementById('referral-subtext');
            ...
            const probLabel =
                document.getElementById('probability-val-label');


            const threshLabel =
                document.getElementById('threshold-val-label');
            ...
            const prob =
                data.referable_probability || 0;


            const threshold =
                data.referral_threshold || 0;
            ...
            if (data.referable) {
                ...
                box.className =
                    "mb-4 p-4 rounded-lg border-2 bg-red-950/40 border-red-700";
                ...
                headline.className =
                    "text-sm font-bold font-mono uppercase tracking-wide block text-red-300";
                ...
                fill.className =
                    "h-full rounded-full transition-all bg-red-500";

            } else {

                box.className =
                    "mb-4 p-4 rounded-lg border-2 bg-emerald-950/30 border-emerald-800";
                ...
                headline.className =
                    "text-sm font-bold font-mono uppercase tracking-wide block text-emerald-300";
                ...
                fill.className =
                    "h-full rounded-full transition-all bg-emerald-500";
            ...
            marker.style.left =
                `calc(${(threshold * 100).toFixed(1)}% - 1px)`;
        ...
        function renderProbabilityBars(classProbabilities) {
            ...
            const container =
                document.getElementById('prob-bars');
        ...
        function setUIDiagnosis(
            ...
            if (
                ...
                stageBadge.className =
                    "text-sm font-bold font-mono text-rose-400 bg-slate-800 p-3 rounded-lg border border-rose-900/50";
                ...
                stageBadge.className =
                    `text-sm font-bold font-mono ${colors.text} ${colors.bg} p-3 rounded-lg border ${colors.border}`;
        ...
        function submitCorrection() {
            ...
            const status =
                document.getElementById('correction-status');
            ...
            if (val === "invalid") {
                ...
                status.innerText =
                    "Cannot save 'Cannot Determine Stage' as a correction.";


                status.className =
                    "text-[10px] font-mono mt-2 text-rose-400";
            ...
            if (!currentPredictionId) {
                ...
                status.innerText =
                    "No active prediction to correct.";
            ...
            fetch(
                ...
                `/predictions/${currentPredictionId}/correct`,
            ...
            .then(() => {
                ...
                status.className =
                    "text-[10px] font-mono mt-2 text-emerald-400";
